...
/**
  ...
  */
class TwoVersionEngineImpl[S <: Struct, TImpl <: TwoVersionPropagation[S]](name: String, newTurn: (TwoVersionEngineImpl[S,TImpl], Option[TImpl]) => TImpl) extends TwoVersionEngine[S, TImpl] {
