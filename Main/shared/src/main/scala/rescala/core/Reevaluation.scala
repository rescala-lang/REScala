...
final case class ReevaluationResultImpl[P, S <: Struct](turn: ReevaluationStateAccess[S], node: WriteableReactive[Pulse.Change[P], S] with Reactive[S], value: Pulse[P], indepsChanged: Boolean, indepsAfter: Set[Reactive[S]], indepsAdded: Set[Reactive[S]], indepsRemoved: Set[Reactive[S]]) extends ReevaluationResult[S] {
...
object ReevaluationResult {
  ...
  /**
    ...
    */
  def Static[P, S <: Struct](turn: ReevaluationStateAccess[S], node: WriteableReactive[Pulse[P], S] with Reactive[S], value: Pulse[P], unchangedIndeps: Set[Reactive[S]]): ReevaluationResultImpl[P, S] =  ReevaluationResultImpl(turn, node, value, indepsChanged = false, unchangedIndeps, Set.empty, Set.empty)
  ...
  /**
    ...
    */
  def Dynamic[P, S <: Struct](turn: ReevaluationStateAccess[S], node: WriteableReactive[Pulse[P], S] with Reactive[S], value: Pulse[P], indepsAfter: Set[Reactive[S]], indepsAdded: Set[Reactive[S]], indepsRemoved: Set[Reactive[S]]): ReevaluationResultImpl[P, S] = ReevaluationResultImpl(turn, node, value, indepsAdded.nonEmpty || indepsRemoved.nonEmpty, indepsAfter, indepsAdded, indepsRemoved)
}
