...
class DotMapChecks            extends LatticePropertyChecks[Dotted[DotMap[kofre.base.Uid, DotSet]]](expensive = false)
...
class GrowOnlyListChecks      extends LatticePropertyChecks[GrowOnlyList[Int]](expensive = false)
