...
the vent is fired again and a new value is available. The
...
function \code{snapshot} can returns a signal that is updated on an
...
\subsubsection{ChangeTo} 

The \code{changeTo} function is similar to \code{changed}, but it
