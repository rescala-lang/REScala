 ...
 */
final class Evt[T]()(engine: SynchronizationFactory) extends Base(engine) with Event[T] with Source[T] {
...
final class Var[T](initval: T)(engine: SynchronizationFactory) extends Base(engine) with Signal[T] with Source[T] {
