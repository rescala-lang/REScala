...
class MapAsUIJDLatticeTest extends AnyFreeSpec with ScalaCheckDrivenPropertyChecks {
  "leq" in forAll { (a: Map[Int, Int], b: Map[Int, Int], c: Map[Int, Int]) =>
    ...
    assert(
      !(MapAsUIJDLattice[Int, Int].leq(a, b) && MapAsUIJDLattice[Int, Int].leq(b, c)) || MapAsUIJDLattice[Int, Int].leq(a, c),
      s"leq should be transitive, but $a leq $b and $b leq $c and $a is not leq $c"
    )
  }
...
class PairAsUIJDLatticeTest extends AnyFreeSpec with ScalaCheckDrivenPropertyChecks {
  "leq" in forAll { (a: (Set[Int], Set[Int]), b: (Set[Int], Set[Int]), c: (Set[Int], Set[Int])) =>
    ...
    assert(
      !(PairAsUIJDLattice[Set[Int], Set[Int]].leq(a, b) && PairAsUIJDLattice[Set[Int], Set[Int]].leq(b, c)) || PairAsUIJDLattice[Set[Int], Set[Int]].leq(a, c),
      s"leq should be transitive, but $a leq $b and $b leq $c and $a is not leq $c"
    )
  }
...
object LexPairGenerators {
  def genLexPair[A: UIJDLattice, B: UIJDLattice](implicit arbA: Arbitrary[A], arbB: Arbitrary[B]): Gen[LexPair[A, B]] = for {
    a <- arbA.arbitrary
    b <- arbB.arbitrary
  } yield LexPair(a, b)

  implicit def arbLexPair[A: UIJDLattice, B: UIJDLattice](implicit arbA: Arbitrary[A], arbB: Arbitrary[B]): Arbitrary[LexPair[A, B]] =
...
class LexPairAsUIJDLatticeTest extends AnyFreeSpec with ScalaCheckDrivenPropertyChecks {
  ...
  "leq" in forAll { (a: LexPair[Set[Int], Set[Int]], b: LexPair[Set[Int], Set[Int]], c: LexPair[Set[Int], Set[Int]]) =>
    ...
    assert(
      !(LexPairAsUIJDLattice[Set[Int], Set[Int]].leq(a, b) && LexPairAsUIJDLattice[Set[Int], Set[Int]].leq(b, c)) || LexPairAsUIJDLattice[Set[Int], Set[Int]].leq(a, c),
      s"leq should be transitive, but $a leq $b and $b leq $c and $a is not leq $c"
    )
  }

  "merge" in forAll { (a: LexPair[Set[Int], Set[Int]], b: LexPair[Set[Int], Set[Int]], c: LexPair[Set[Int], Set[Int]]) =>
