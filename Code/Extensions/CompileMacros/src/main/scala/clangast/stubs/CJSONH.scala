...
object CJSONH extends CLibraryStub {
  ...
  def valuestring(expr: CExpr)(using TranslationContext): CExpr = includeStub(CMemberExpr(CParenExpr(expr), "valuestring", true))
  def valueint(expr: CExpr)(using TranslationContext): CExpr = includeStub(CMemberExpr(CParenExpr(expr), "valueint", true))
  def valuedouble(expr: CExpr)(using TranslationContext): CExpr = includeStub(CMemberExpr(CParenExpr(expr), "valuedouble", true))
  ...
  def cJSON_ParseWithLength(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_ParseWithLength"))
  def cJSON_ParseWithOpts(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_ParseWithOpts"))
  def cJSON_ParseWithLengthOpts(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_ParseWithLengthOpts"))
  def cJSON_Print(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_Print"))
  def cJSON_PrintUnformatted(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_PrintUnformatted"))
  def cJSON_PrintBuffered(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_PrintBuffered"))
  def cJSON_PrintPreallocated(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_PrintPreallocated"))
  ...
  def cJSON_GetObjectItemCaseSensitive(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_GetObjectItemCaseSensitive"))
  ...
  def cJSON_CreateStringReference(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_CreateStringReference"))
  def cJSON_CreateObjectReference(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_CreateObjectReference"))
  def cJSON_CreateArrayReference(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_CreateArrayReference"))
  def cJSON_CreateIntArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_CreateIntArray"))
  def cJSON_CreateFloatArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_CreateFloatArray"))
  def cJSON_CreateDoubleArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_CreateDoubleArray"))
  def cJSON_CreateStringArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_CreateStringArray"))
  def cJSON_AddItemToArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddItemToArray"))
  def cJSON_AddItemToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddItemToObject"))
  def cJSON_AddItemToObjectCS(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddItemToObjectCS"))
  def cJSON_AddItemReferenceToArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddItemReferenceToArray"))
  def cJSON_AddItemReferenceToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddItemReferenceToObject"))
  def cJSON_DetachItemViaPointer(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_DetachItemViaPointer"))
  def cJSON_DetachItemFromArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_DetachItemFromArray"))
  def cJSON_DeleteItemFromArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_DeleteItemFromArray"))
  def cJSON_DetachItemFromObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_DetachItemFromObject"))
  def cJSON_DetachItemFromObjectCaseSensitive(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_DetachItemFromObjectCaseSensitive"))
  def cJSON_DeleteItemFromObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_DeleteItemFromObject"))
  def cJSON_DeleteItemFromObjectCaseSensitive(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_DeleteItemFromObjectCaseSensitive"))
  def cJSON_InsertItemInArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_InsertItemInArray"))
  def cJSON_ReplaceItemViaPointer(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_ReplaceItemViaPointer"))
  def cJSON_ReplaceItemInArray(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_ReplaceItemInArray"))
  def cJSON_ReplaceItemInObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_ReplaceItemInObject"))
  def cJSON_ReplaceItemInObjectCaseSensitive(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_ReplaceItemInObjectCaseSensitive"))
  ...
  def cJSON_AddNullToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddNullToObject"))
  def cJSON_AddTrueToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddTrueToObject"))
  def cJSON_AddFalseToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddFalseToObject"))
  def cJSON_AddBoolToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddBoolToObject"))
  def cJSON_AddNumberToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddNumberToObject"))
  def cJSON_AddStringToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddStringToObject"))
  def cJSON_AddRawToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddRawToObject"))
  def cJSON_AddObjectToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddObjectToObject"))
  def cJSON_AddArrayToObject(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_AddArrayToObject"))
  def cJSON_SetNumberHelper(using TranslationContext): CFunctionDecl = includeStub(CFunctionStub("cJSON_SetNumberHelper"))
