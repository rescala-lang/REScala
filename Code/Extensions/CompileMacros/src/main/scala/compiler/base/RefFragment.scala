...
object RefFragment extends RefIFFragment {
  override def compileRef(using Quotes)(using FragmentedCompiler)(using TranslationContext):
  ...
  override def compileIdent(using Quotes)(using FragmentedCompiler)(using TranslationContext):
