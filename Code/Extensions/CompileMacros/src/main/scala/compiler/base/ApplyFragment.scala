...
object ApplyFragment extends ApplyIFFragment {
  override def compileApply(using Quotes)(using FragmentedCompiler)(using ctx: TranslationContext):
    PartialFunction[quotes.reflect.Apply, CExpr] = {
...

      {
        case Apply(Select(Select(Ident("math"), "package"), "max"), List(arg1, arg2)) =>
          ...
          val v1 = CVarDecl(v1Name, dispatch[TypeIFFragment](_.compileTypeRepr)(arg1.tpe), Some(dispatch[TermIFFragment](_.compileTermToCExpr)(arg1)))
          val v2 = CVarDecl(v2Name, dispatch[TypeIFFragment](_.compileTypeRepr)(arg2.tpe), Some(dispatch[TermIFFragment](_.compileTermToCExpr)(arg2)))
  ...
  private def isPrimitiveType(using Quotes)(tpe: quotes.reflect.TypeRepr)(using FragmentedCompiler)(using TranslationContext): Boolean =
  ...
  private def compileApplyToCBinaryOperator(using Quotes)(apply: quotes.reflect.Apply)(using FragmentedCompiler)(using TranslationContext): CParenExpr = {
    import quotes.reflect.*
