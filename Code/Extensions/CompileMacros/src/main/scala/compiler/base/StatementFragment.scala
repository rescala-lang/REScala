...
object StatementFragment extends StatementIFFragment {
  override def compileStatement(using Quotes)(using FragmentedCompiler)(using TranslationContext):
  ...
  override def compileStatementToCStmt(using Quotes)(using FragmentedCompiler)(using TranslationContext):
