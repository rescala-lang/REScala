...
object TermFragment extends TermIFFragment {
  override def compileTerm(using Quotes)(using FragmentedCompiler)(using TranslationContext):
    PartialFunction[quotes.reflect.Term, CASTNode] = {
...

      {
        ...
        case Block(List(defDef: DefDef), Literal(UnitConstant())) => dispatch[DefinitionIFFragment](_.compileDefDef)(defDef)
  ...
  override def compileTermToCStmt(using Quotes)(using FragmentedCompiler)(using TranslationContext):
  ...
  override def compileLiteral(using Quotes)(using FragmentedCompiler)(using TranslationContext):
  ...
  override def compileAssign(using Quotes)(using FragmentedCompiler)(using ctx: TranslationContext):
  ...
  override def compileBlockToCStmtExpr(using Quotes)(using FragmentedCompiler)(using ctx: TranslationContext):
  ...
  override def compileBlockToCCompoundStmt(using Quotes)(using FragmentedCompiler)(using TranslationContext):
  ...
  override def compileBlockToFunctionBody(using Quotes)(using FragmentedCompiler)(using TranslationContext):
    PartialFunction[quotes.reflect.Block, CCompoundStmt] = {
      import quotes.reflect.*
  ...
  override def compileIfToCIfStmt(using Quotes)(using FragmentedCompiler)(using TranslationContext):
  ...
  override def compileIfToCConditionalOperator(using Quotes)(using FragmentedCompiler)(using TranslationContext):
  ...
  override def compileReturn(using Quotes)(using FragmentedCompiler)(using TranslationContext):
  ...
  override def compileWhile(using Quotes)(using FragmentedCompiler)(using TranslationContext):
