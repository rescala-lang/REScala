...
class ArrayRangesTest2 extends AnyFlatSpec {
  ...
  it should "work with duplicates" in {
    ...
    ArrayRanges.from(Seq[Time](1, 3, 3, 3, 4, 4, 5, 8, 8, 10).iterator) shouldEqual ArrayRanges(Seq(
      (1, 2),
      (3, 6),
      (8, 9),
      (10, 11)
  ...
  it should "work overlap on left but not right" in {
    ...
    (ArrayRanges(Seq((1, 10), (11, 20))) subtract ArrayRanges(Seq((0, 5)))) shouldEqual ArrayRanges(Seq(
      (5, 10),
      (11, 20)
    ))
    (ArrayRanges(Seq((1, 10), (11, 20))) subtract ArrayRanges(Seq((11, 19)))) shouldEqual ArrayRanges(Seq(
      (1, 10),
      (19, 20)
    ))
    (ArrayRanges(Seq((1, 10), (11, 20))) subtract ArrayRanges(Seq((10, 19)))) shouldEqual ArrayRanges(Seq(
      (1, 10),
      (19, 20)
    ))
    (ArrayRanges(Seq((1, 10), (11, 20), (21, 22))) subtract ArrayRanges(Seq((11, 19)))) shouldEqual ArrayRanges(Seq(
      (1, 10),
      (19, 20),
      (21, 22)
    ))
  ...
  it should "work for combinations of overlap" in {
    (ArrayRanges(Seq((0, 2), (5, 10), (11, 20))) subtract ArrayRanges(Seq((0, 5)))) shouldEqual ArrayRanges(Seq(
      (5, 10),
      (11, 20)
    ))
    (ArrayRanges(Seq((0, 2), (5, 10), (11, 20))) subtract ArrayRanges(Seq((0, 6)))) shouldEqual ArrayRanges(Seq(
      (6, 10),
      (11, 20)
    ))
    (ArrayRanges(Seq((0, 2), (5, 10), (11, 20))) subtract ArrayRanges(Seq((6, 19)))) shouldEqual ArrayRanges(Seq(
      (0, 2),
      (5, 6),
      (19, 20)
    ))
    (ArrayRanges(Seq((0, 2), (5, 10), (11, 20))) subtract ArrayRanges(Seq((6, 22)))) shouldEqual ArrayRanges(Seq(
      (0, 2),
      (5, 6)
    ))
  }
