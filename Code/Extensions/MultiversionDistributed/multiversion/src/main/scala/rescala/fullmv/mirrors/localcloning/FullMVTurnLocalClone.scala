        ...
        turn.guid, {
          ...
          val mirrorProxy: FullMVTurnProxy = new FullMVTurnProxy {
            ...
            override def asyncRemoteBranchComplete(forPhase: TurnPhase.Type): Unit =
              FakeDelayer.async(reflectionHost, mirrorHost, fakeDelay, localMirror.asyncRemoteBranchComplete(forPhase))
            ...
            override def remoteTrySubsume(lockedNewParent: SubsumableLock): Future[TrySubsumeResult] =
              FakeDelayer.requestReply(
                ...
                mirrorHost,
                fakeDelay,
                localMirror.remoteTrySubsume(SubsumableLockLocalClone(lockedNewParent, mirrorHost.lockHost, fakeDelay))
              )
