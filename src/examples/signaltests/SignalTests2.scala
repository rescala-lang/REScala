...
object SignalTests2 extends Application with scalareact.Observing {
  ...
  import scala.events.behaviour.SignalConversions._
     ///dep2 += {x => println("Hello from EScala: " + x)}
  ...
  //scala.events.scalareact.runTurn {}
  
  //println(dep2.getValue)
