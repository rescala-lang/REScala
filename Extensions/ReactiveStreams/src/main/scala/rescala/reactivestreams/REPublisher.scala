...
object REPublisher {
  ...
  class SubscriptionReactive[T, S <: Struct](bud: S#Type[T, Reactive[S]], dependency: Pulsing[T, S], subscriber: Subscriber[_ >: T], fac: Engine[S, Turn[S]]) extends Base[T, S](bud) with Reactive[S] with Subscription {
